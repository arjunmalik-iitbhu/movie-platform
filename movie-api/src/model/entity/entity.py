...
from sqlalchemy import BigInteger, CheckConstraint, Column, DateTime, ForeignKeyConstraint, Integer, PrimaryKeyConstraint, String, Text, text
...
class Movie(SQLModel, table=True):
    __table_args__ = (
        ...
        ForeignKeyConstraint(['director_id'], ['director.id'], ondelete='CASCADE', onupdate='CASCADE', name='movie_foreign_key_director_id'),
    ...
    created_at: datetime.datetime = Field(sa_column=Column('created_at', DateTime(True), nullable=False, server_default=text('CURRENT_TIMESTAMP')))
    updated_at: datetime.datetime = Field(sa_column=Column('updated_at', DateTime(True), nullable=False, server_default=text('CURRENT_TIMESTAMP')))
    director_id: Optional[int] = Field(default=None, sa_column=Column('director_id', BigInteger))
...
class MovieRating(SQLModel, table=True):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['movie_id'], ['movie.id'], ondelete='CASCADE', onupdate='CASCADE', name='movie_rating_foreign_key_movie_id'),
        PrimaryKeyConstraint('id', name='movie_rating_primary_key')
    )

    id: int = Field(sa_column=Column('id', BigInteger, primary_key=True))
    comment: str = Field(sa_column=Column('comment', Text, nullable=False, server_default=text("''::text")))
    story: int = Field(sa_column=Column('story', Integer, nullable=False, server_default=text('4')))
    direction: int = Field(sa_column=Column('direction', Integer, nullable=False, server_default=text('4')))
    acting: int = Field(sa_column=Column('acting', Integer, nullable=False, server_default=text('4')))
    created_at: datetime.datetime = Field(sa_column=Column('created_at', DateTime(True), nullable=False, server_default=text('CURRENT_TIMESTAMP')))
    updated_at: datetime.datetime = Field(sa_column=Column('updated_at', DateTime(True), nullable=False, server_default=text('CURRENT_TIMESTAMP')))
    movie_id: Optional[int] = Field(default=None, sa_column=Column('movie_id', BigInteger))
...
class MovieToActor(SQLModel, table=True):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['actor_id'], ['actor.id'], ondelete='CASCADE', onupdate='CASCADE', name='movie_to_actor_foreign_key_actor_id'),
        ForeignKeyConstraint(['movie_id'], ['movie.id'], ondelete='CASCADE', onupdate='CASCADE', name='movie_to_actor_foreign_key_movie_id'),
...
class MovieToGenre(SQLModel, table=True):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['genre_id'], ['genre.id'], ondelete='CASCADE', onupdate='CASCADE', name='movie_to_genre_foreign_key_genre_id'),
        ForeignKeyConstraint(['movie_id'], ['movie.id'], ondelete='CASCADE', onupdate='CASCADE', name='movie_to_genre_foreign_key_movie_id'),
